...
textarea.addEventListener("input", function () {
  ...
  characterCount.textContent =
    "Contador de carácteres: " + characterCountanalizer;

  const characterNoSpacesCountanalizer =
    analyzer.getCharacterCountExcludingSpaces(texto);
  characterNoSpacesCount.textContent =
    "Contador de carácteres sin espacios " + characterNoSpacesCountanalizer;
  ...
  wordLengthAverage.textContent =
    "Longitud de palabras " + wordLengthAverageanalizer;
});
